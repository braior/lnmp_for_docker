...
0
|| checktplrefresh('/usr/local/nginx/html/bbs/././templates/default/discuz.htm', '/usr/local/nginx/html/bbs/././templates/default/header.htm', 1567497869, '1', './templates/default')
|| checktplrefresh('/usr/local/nginx/html/bbs/././templates/default/discuz.htm', '/usr/local/nginx/html/bbs/././templates/default/index_heats.htm', 1567497869, '1', './templates/default')
|| checktplrefresh('/usr/local/nginx/html/bbs/././templates/default/discuz.htm', '/usr/local/nginx/html/bbs/././templates/default/index_navbar.htm', 1567497869, '1', './templates/default')
|| checktplrefresh('/usr/local/nginx/html/bbs/././templates/default/discuz.htm', '/usr/local/nginx/html/bbs/././templates/default/footer.htm', 1567497869, '1', './templates/default')
|| checktplrefresh('/usr/local/nginx/html/bbs/././templates/default/discuz.htm', '/usr/local/nginx/html/bbs/././templates/default/jsmenu.htm', 1567497869, '1', './templates/default')
;?>
...
<link href="forumdata/cache/style_1_moderator.css?15G" rel="stylesheet" type="text/css" />
