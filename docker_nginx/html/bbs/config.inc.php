...
define('UC_DBHOST', '172.18.0.3');
define('UC_DBUSER', 'farm');
define('UC_DBPW', 'farm');
define('UC_DBNAME', 'farm');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`farm`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', '62S0ockdEbW0K90421D0j8ncTbr1k346yfcel64873N6Z4e3m8K02bD8K4L1R6Y8');
define('UC_API', 'http://47.110.58.173:8082/ucenter');
define('UC_CHARSET', 'utf-8');
define('UC_IP', '47.110.58.173');
define('UC_APPID', '2');
define('UC_PPP', '20');