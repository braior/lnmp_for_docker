...
*
* @modify      seaif@zealv.com at 2010/02/19 21:39
*/
...
class Services_JSON {
	...
	function reduce_string($str) {
		$str = preg_replace(array( // eliminate single line comments in '// ...' form
...
/**
 * add by seaif@zealv.com
 * json function for PHP Version < 5.2.1
 */
if(!($jsonEN = function_exists('json_encode')) || !($jsonDE = function_exists('json_decode'))) {
	...
	if(!$jsonDE) {
		...
		function json_decode($data, $type = false) {
			global $json;
			if($type) {
