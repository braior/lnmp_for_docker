...
$query = $_QFG['db']->query("SELECT C.uid,C.username,C.money,C.vip,C.pf,N.exp FROM " . getTName("qqfarm_config") . " C Left JOIN " . getTName("qqfarm_mc") . " N ON N.uid=C.uid" . $condition);
