...
define('UC_DBHOST', '172.18.0.3'); // UCenter 数据库主机
define('UC_DBUSER', 'farm'); // UCenter 数据库用户名
define('UC_DBPW', 'farm'); // UCenter 数据库密码
define('UC_DBNAME', 'farm'); // UCenter 数据库名称
define('UC_DBCHARSET', 'utf8'); // UCenter 数据库字符集
define('UC_DBTABLEPRE', '`farm`.uc_'); // UCenter 数据库表前缀
define('UC_DBCONNECT', '0'); // UCenter 数据库持久连接 0=关闭, 1=打开
define('UC_KEY', 'E0Z6V1Z8C1o9U1R3k8K3UdCfF5W0WeL0g57ad1j15f87i6p0qdW1s0c47bK6UcMf'); // 与 UCenter 的通信密钥, 要与 UCenter 保持一致
define('UC_API', 'http://47.110.58.173/ucenter'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
